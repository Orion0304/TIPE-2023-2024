...
def decodage_3(nbrep, nmfichier):
    ...
    while i < n-4*nbrep: #tant qu'il est possible de coder nbrep lettres dans le reste du fichier
        ...
        while ite<nbrep:
            ...
            a1 = (sequence[1]-64*(sequence[1]//64))//16
            a2 = (sequence[3]-64*(sequence[3]//64))//16
            a3 = (sequence[5]-64*(sequence[5]//64))//16
            a4 = (sequence[7]-64*(sequence[7]//64))//16
